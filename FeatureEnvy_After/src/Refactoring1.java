...
class HouseholdBook{
    ...
    public int getTotalPrice(){
        return commonExpenses.getCommonExpensesPrice() +
                childrenExpense.getChildrenExpensePrice();
    }
}
...
class CommonExpenses{
    ...
    public int getCommonExpensesPrice(){
        return houseRent + tax + carGas + food;
    }
}
...
class ChildrenExpense{
    ...
    public int getChildrenExpensePrice(){
        return education + pocketMoney;
    }
}